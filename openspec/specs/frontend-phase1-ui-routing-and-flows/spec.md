...
The frontend SHALL compose lobby and room surfaces using shadcn primitives and Tailwind utilities to achieve Spotify-like information hierarchy and interaction behavior.

#### Scenario: Lobby composition
- **WHEN** rendering lobby create/join page
- **THEN** UI uses shadcn Card, Tabs, Input, Button, Alert, and Toast for action and feedback

#### Scenario: Jam room composition
- **WHEN** rendering jam room and focused views
- **THEN** UI uses shadcn Card, Tabs, Badge, ScrollArea, Slider, Tooltip, Dialog, Skeleton, and Alert patterns for queue, playback, participants, and diagnostics
